<template>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Benjamin Hole, Solheimsgaten 12.</p>
    </li>
    <li>
    ...
    <li>
        <p><strong>Website</strong> refers to Haugaland Party Band, accessible from <a href="https://haugalandpartyband.no" rel="external nofollow noopener" target="_blank">https://haugalandpartyband.no</a></p>
    </li>
    <li>
    ...
    <ul>
        <li>By email: Benjamin.hole@outlook.com</li>
    </ul>
</template>
